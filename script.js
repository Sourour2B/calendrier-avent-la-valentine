...
const ADVENT_CONTENT = {
    ...
    14: { 
        title: "Jour 14 : Qu’est-ce que l’instance paritaire régionale (IPR) ? ", 
         text: "Les Instances Paritaires Régionales (IPR) ont été créées par la loi du 13 février 2008 relative à la réforme de l’organisation du service public de l’emploi.<br><br>L’Instance Paritaire Régionale (IPR) est chargée de veiller à l’application des accords relatifs à l’assurance chômage.<br>Elle est consultée sur la programmation des interventions régionales de France Travail.<br>Au sein de chaque direction régionale de France Travail, une Instance Paritaire Régionale (IPR) est mise en place. Chaque Instance Paritaire Régionale (IPR) est composée de 10 membres dont 5 représentent les employeurs et 5 représentent les salariés. Ils sont respectivement désignés par le MEDEF, la CPME et l’U2P, d’une part, et FO, la CFDT, la CFTC, la CFE-CGC et la CGT d’autre part, pour une durée de trois ans renouvelable.<br>Les décisions sont prises à la majorité absolue et les séances ne sont pas publiques. <br><br>Qui est concerné par l’instance paritaire régionale ?<br> Tout demandeur d’emploi peut saisir Les Instances Paritaires Régionales (IPR) pour examiner sa situation individuelle dans l’un des cas de figure prévus par les accords d’assurance chômage.<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;• Conséquence sur l’indemnisation du départ volontaire d’un emploi précédemment occupé<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;• Appréciation de certaines conditions d’ouverture de droits <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;• Maintien du versement des prestations <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;• Remises des allocations et prestations indûment perçues <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;• Examen en cas d'absence de déclaration de période d'activité <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;• Atteinte du plafond du cumul de l'Allocation d'aide au Retour à l'Emploi et d'une activité non-salariée ",
        image: "assets/contenu-1.jpg" 
    },
    15: { 
        title: "Jour 15 : ACTU ", 
